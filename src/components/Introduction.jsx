...
const Introduction = () => {
    return (
        <div className="flex flex-col-reverse lg:flex-row justify-center items-center h-4/5 lg:h-3/5">
    ...
    <img src={selfImage} className="aspect-square w-4/5 max-h-full rounded-full " alt={"Me!"}></img>
    </div>
        </div>
    );
}
