...
const Footer = () => {
    return (
        <footer className="p-4 w-full sm:w-4/5 lg:w-1/2 flex flex-row lg:flex-row text-white justify-between items-center lg:items-start border-t border-gray-700 pt-3 pb-8">
